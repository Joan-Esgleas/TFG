...
BENCHMARK_GCC_OPTS = -march=rv64ima_zicsr_zifencei_zfinx -mabi=lp64 -DPREALLOCATE=1 -mcmodel=medany -static -std=gnu99 -O2 -ffast-math -fno-common -fno-builtin-printf -fno-tree-loop-distribute-patterns -DSMALL_TESTS
