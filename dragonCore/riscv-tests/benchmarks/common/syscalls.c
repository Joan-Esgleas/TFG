...
#define READ_CTR(name, label) do { \
  ...
  READ_CTR(mhpmcounter3,  "Executed Branches");
  READ_CTR(mhpmcounter4,  "Missed Branches");
  READ_CTR(mhpmcounter5, "Stalls by Data Dependencies");
  READ_CTR(mhpmcounter6, "Stalls by Structural Risks");
...
static void init_hpm() {
  ...
  write_csr(mhpmevent5,   20);
  write_csr(mhpmevent6,   21);
}
